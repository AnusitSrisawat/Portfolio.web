...
const [count, setCount] = useState(0)
    ...
    return (
        <div className='relative w-full lg:w-2/5 h-[80vh] lg:h-full bg-pink-300 border-4 border-pink-300 rounded-3xl p-5 lg:p-10 flex flex-col gap-5 md:gap-8 justify-start items-center overflow-auto' >
